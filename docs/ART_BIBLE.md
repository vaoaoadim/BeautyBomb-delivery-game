...
- The 100% progress frame leads into a `1,500 ms` obstacle-free victory drive. It then uses one full-viewport black cinematic fade (`600 ms` out, `100 ms` covered swap, `680 ms` in) before the visible arrival brake. The bounded rectangular confetti in yellow, pink, cyan, violet, and white begins after visibility returns, never underneath the black transition.
