"""Build UI-006 v1 as an exact pause-popup visual sibling."""
...
TARGET = OUTPUT / "ui-006-defeat-callout-v1.png"
...
def draw_callout(font: ImageFont.FreeTypeFont) -> Image.Image:
    ...
    if sum(image.getchannel("A").histogram()[1:255]):
        raise RuntimeError("UI-006 v1 contains antialiased alpha values")
    return image
